...
class PointerParticles extends HTMLElement {
  ...
  setPointerValues(event) {
      ...
      this.pointer.x = point.clientX - this.offsetLeft;
      this.pointer.y = point.clientY - this.offsetTop;
      this.pointer.mx = isTouchEvent ? 0 : event.movementX;
      this.pointer.my = isTouchEvent ? 0 : event.movementY;
  }
